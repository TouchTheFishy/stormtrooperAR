...
public class ColorDetectionActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2{
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        Core.inRange(HSVcopy,new Scalar(0,154,164),new Scalar(31,255,255),RedTresh);
        ...
        Imgproc.findContours(RedTresh, Rcontours, hierarchy, Imgproc.RETR_EXTERNAL, Imgproc.CHAIN_APPROX_SIMPLE);
        ...
        if (!Rcontours.isEmpty()) {
            ...
            for (int idx = 0; idx<Rcontours.size(); idx ++) {

                MatOfPoint contour = Rcontours.get(idx);
                ...
                if (total >= 4 && total <= 6) {
                    ...
                    if (isRect) {
                        if(contourArea>100){
                            ...
                            Imgproc.drawContours(mRgba, Rcontours, idx, new Scalar(255, 0, 0), 5);
                            maxcntID =idx;
                            //Thanks to foundColor, we know what kind of color was found
                            foundColor = 1;
        ...
        if(!Gcontours.isEmpty() || !Rcontours.isEmpty()) {
            //Save the value of the found color in order to send it to the main activity
            if(foundColor==1){
                Imgproc.drawContours(mRgba, Rcontours, maxcntID, new Scalar(255, 0, 0), 5);
                ...
                if(redFrame<33){
                    ...
                    foundColor=1;
                    //this is the sent value to the main activity
                    finalColor = "RED";
                }
            }
        ...
        //send the value to the main activity
